...
SourceTeam.create(fpl_id: source["teams"][9]["code"], name: source["teams"][9]["name"], badge_url: "https://platform-static-files.s3.amazonaws.com/premierleague/badges/t#{source["teams"][9]["code"]}.svg", home_colour_1: "cornflowerblue", home_colour_2: "slategray", away_colour_1: "black", away_colour_2: "maroon")
